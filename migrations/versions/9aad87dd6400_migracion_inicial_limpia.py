...
def upgrade():
    ...
    tables = [
        'psicologo_especialidad', 'citas', 'pacientes', 'psicologos', 
        'administrador', 'especialidades', 'anamnesis', 'notas_sesion', 
        'informes', 'facturas', 'notificaciones', 'tareas_informes', 
        'consentimientos_informados', 'resenas'
    ]
    for table in tables:
