    ...
    def verify_identity(self, dni_image_bytes, selfie_image_bytes):
        ...
        try:
            ...
            if dni_cropped is None:
                return {"verified": False, "msg": "No se detectó ninguna cara en el DNI"}
            
            if selfie_cropped is None:
                return {"verified": False, "msg": "No se detectó ninguna cara en el Selfie"}
            ...
            return {
                ...
                "msg": "Identidad verificada" if is_match else "Las caras no coinciden suficientemente"
            }

        except Exception as e:
            print(f"Biometric Error: {e}")
            return {"verified": False, "msg": f"Error interno: {str(e)}"}
