...
def verify_psicologo_copc(numero_colegiado):
    """
    Verifica si un psicólogo está colegiado en el COPC (Catalunya) usando su número de colegiado.
    Retorna un diccionario con el estado de verificación y el nombre si se encuentra.
    """
    ...
    # URL de búsqueda del COPC
    url = f"https://copc-staging.indaws.cloud/es/colegiat?tec_num_colegiat={numero_limpio}"
    ...
    try:
        ...
        # Según la investigación, los resultados están en <table> <tbody> <tr>
